                                ...
                                <Dropdown v-if="$page.props.jetstream.hasTeamFeatures" align="right" width="60">
                                    ...
                                    <template #content>
                                        <div class="w-60">
                                            ...
                                            <!-- Team Switcher -->
                                            <template v-if="user?.all_teams && user.all_teams.length > 1">
                                                    ...
                                                    <form @submit.prevent="switchToTeam(team)">
                                                        <DropdownLink as="button">
                                                            <div class="flex items-center">
                                                                <svg v-if="team.id == user?.current_team_id" class="me-2 h-5 w-5 text-green-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
